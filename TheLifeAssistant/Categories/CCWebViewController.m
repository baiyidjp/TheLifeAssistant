...
@interface CCWebViewController ()<UIWebViewDelegate,UIActionSheetDelegate,WKNavigationDelegate>
...
//    UIButton *backBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 27, 30)];
...
- (void)configColseItem {
    ...
    // 导航栏的关闭按钮
    UIButton *colseBtn = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, 22, 22)];
    ...
    [colseBtn.titleLabel setFont:[UIFont systemFontOfSize:16]];
